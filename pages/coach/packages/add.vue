            ...
            <v-row class=" textFile">
                <v-col cols=" 12" md="6" style="padding-bottom:0">
                    <v-col cols="12" md="12" style="padding-bottom:0;">
                        <v-text-field label="Title" placeholder="" v-model="title" outlined :rules="[v => !!v || 'This filed is required']"></v-text-field>
                    </v-col>
                    <v-col cols=" 12" md="12" style="padding-bottom:0">
                        <v-autocomplete v-model="type" outlined :items="package_types" item-text="name" label="Type" clearable :rules="[v => !!v || 'This filed is required']"></v-autocomplete>
                    </v-col>
                    <v-col cols="12" md="12" style="padding-bottom:0">
                        <v-autocomplete v-model="payment_type" outlined :items="payment_types" item-text="name" label="Payment Types" clearable :rules="[v => !!v || 'This filed is required']"></v-autocomplete>
                    </v-col>
                    <v-col cols=" 12" md="12" style="padding-bottom:0">
                ...
                <v-col cols="12" md="12">
                    <div class="d-flex justify-end mt-4 mb-4">
                        <v-btn class="btnpost fit-btn-x" elevation="2" x-large color="primary" @click="PostPackage"> post
                        </v-btn>
                    </div>
                    <!-- testtttttttttttttt-->
                </v-col>
    ...
    methods: {
        ...
        async PostPackage() {
            ...
            if (this.$refs.form.validate()) {
                ...
                formDataObj.append('price', this.price)
                formDataObj.append('weeks', this.weeks)
                formDataObj.append('type', this.type)
                formDataObj.append('form_id', this.package_form)
                formDataObj.append('payment_type', this.payment_type)
                ...
                /* ======= Send To API  ======= */
                await this.$axios.post('coach-packages/add', formDataObj, {
